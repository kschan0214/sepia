...
% Date modified: 17 Feb 2022
%
%
function chi = FANSI_4sepia_v1(phase,magn,spatial_res,alpha,mu,noise,options,B0_dir)
...
if options.isWeakHarmonic
    ...
    if options.nonlinear
        if options.tgv
            ...
            out = WH_nlTV_4sepia_v1(params);
        end

    else
        if options.tgv
            out = WH_wTGV_4sepia_v1(params);
        else
            out = WH_wTV(params);
        end
