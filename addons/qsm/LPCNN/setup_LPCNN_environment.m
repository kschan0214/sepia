...
LPCNN_HOME          = '/autofs/space/linen_001/users/kwokshing/tools/sepia/external/LPCNN/LPCNN_v1.0';
% Specify the Python environment that has QSMnet+ installed
python_interpreter  = '/autofs/space/linen_001/users/kwokshing/tools/sepia/external/LPCNN/LPCNN_v1.0/lpcnn-env/bin/python';
