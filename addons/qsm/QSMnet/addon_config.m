...
addons.method = 'QSMnet+';

% Specify the filename of the wrapper function (without extension)
addons.wrapper_function	= 'Wrapper_QSM_QSMnet';
...
addons.gui_method_panel	= 'sepia_handle_panel_qsm_QSMnet';
...
addons.config_function	= 'get_set_qsm_QSMnet';