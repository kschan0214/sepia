...
HEIDI_HOME = fullfile(SEPIA_HOME,'..','external','HEIDI_SEPIAready');                                      % TODo: temporary hard-coded, will update
...
options.PostProcCone.threshold                  = algorParam.qsm.heidi_PostProcCone_threshold;
options.PostProcCone.tol                        = algorParam.qsm.heidi_PostProcCone_tol;
...
function algorParam2 = check_and_set_algorithm_default(algorParam,options)
    ...
    try algorParam2.qsm.heidi_tolerance = algorParam.qsm.heidi_tolerance; % LSQR
        catch; algorParam2.qsm.heidi_tolerance = 1e-5; end
    try algorParam2.qsm.heidi_maxiter = algorParam.qsm.heidi_maxiter; % LSQR
        catch; algorParam2.qsm.heidi_maxiter = 400; end
    try algorParam2.qsm.heidi_offsetUseBool = algorParam.qsm.heidi_offsetUseBool; % LSQR
        catch; algorParam2.qsm.heidi_offsetUseBool = true; end
    try algorParam2.qsm.heidi_isFourierDomainFormula = algorParam.qsm.heidi_isFourierDomainFormula; % LSQR+HEIDI
        catch; algorParam2.qsm.heidi_isFourierDomainFormula = false; end
    try algorParam2.qsm.heidi_TikhonovRegularizationSusceptibility = algorParam.qsm.heidi_TikhonovRegularizationSusceptibility; % LSQR+HEIDI
        catch; algorParam2.qsm.heidi_TikhonovRegularizationSusceptibility = []; end
        if strcmpi(algorParam2.qsm.heidi_TikhonovRegularizationSusceptibility,'default'); algorParam2.qsm.heidi_TikhonovRegularizationSusceptibility = []; end  % 20250614 KC: compatible to GUI
    try algorParam2.qsm.heidi_solvingType = algorParam.qsm.heidi_solvingType; % LSQR+HEIDI
        if strcmpi(algorParam2.qsm.heidi_solvingType,'default'); algorParam2.qsm.heidi_solvingType = []; end % 20250614 KC: compatible to GUI
        catch; algorParam2.qsm.heidi_solvingType = []; end
    try algorParam2.qsm.heidi_DipoleFilter = algorParam.qsm.heidi_DipoleFilter; % LSQR+HEIDI
        if strcmpi(algorParam2.qsm.heidi_DipoleFilter,'default'); algorParam2.qsm.heidi_DipoleFilter = []; end % 20250614 KC: compatible to GUI
        catch; algorParam2.qsm.heidi_DipoleFilter = []; end
    try algorParam2.qsm.heidi_residualWeighting = algorParam.qsm.heidi_residualWeighting; % LSQR
        catch; algorParam2.qsm.heidi_residualWeighting = 0.2 / 9.4 * options.magneticFieldStrength; end
    ...
    try algorParam2.qsm.heidi_PostProcCone_threshold = algorParam.qsm.heidi_PostProcCone_threshold; % HEIDI
        catch; algorParam2.qsm.heidi_PostProcCone_threshold = 0.1; end
    try algorParam2.qsm.heidi_PostProcCone_tol = algorParam2.qsm.heidi_PostProcCone_tol; % HEIDI
        catch; algorParam2.qsm.heidi_PostProcCone_tol = eps; end
    try algorParam2.qsm.heidi_PostProcCone_tolEnergy = algorParam2.qsm.heidi_PostProcCone_tolEnergy; % HEIDI
        catch; algorParam2.qsm.heidi_PostProcCone_tolEnergy = eps; end
