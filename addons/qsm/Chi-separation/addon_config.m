...
% Date modified: 01 December 2025 by Taechang Kim @ SNU (sakkar2@snu.ac.kr)
%
...
addons.method = 'Chi-separation';

% Specify the filename of the wrapper function (without extension)
addons.wrapper_function	= 'Wrapper_QSM_Chi_separation';
...
addons.gui_method_panel	= 'sepia_handle_panel_qsm_Chi_separation';
...
addons.config_function	= 'get_set_qsm_Chi_separation';