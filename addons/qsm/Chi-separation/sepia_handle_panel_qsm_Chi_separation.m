...
switch field
    case 'R2star'
        ...
        [fileName,pathDir] = uigetfile({'*.nii*','NIfTI file (*.nii, *.nii.gz)'; '*.nii','NIfTI file (*.nii)'; '*.nii.gz','Gzipped NIfTI file (*.nii.gz)'},'Select a NIfTI file for R2star');
    ...
    case 'R2'
        % only read NIfTI file for R2star
        [fileName,pathDir] = uigetfile({'*.nii*','NIfTI file (*.nii, *.nii.gz)'; '*.nii','NIfTI file (*.nii)'; '*.nii.gz','Gzipped NIfTI file (*.nii.gz)'},'Select a NIfTI file for R2');
