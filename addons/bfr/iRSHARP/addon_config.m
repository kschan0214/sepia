...
addons.method = 'iRSHARP (testing)';

% Specify the filename of the wrapper function (without extension)
addons.wrapper_function	= 'Wrapper_BFR_iRSHARP';
...
addons.gui_method_panel	= 'sepia_handle_panel_bkgRemoval_iRSHARP';
...
addons.config_function	= 'get_set_bfr_iRSHARP';