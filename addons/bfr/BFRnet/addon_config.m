...
addons.method = 'BFRnet';

% Specify the filename of the wrapper function (without extension)
addons.wrapper_function	= 'Wrapper_BFR_BFRnet';
...
addons.gui_method_panel	= 'sepia_handle_panel_bkgRemoval_BFRnet';
...
addons.config_function	= 'get_set_bfr_BFRnet';