...
h.StepsPanel.Utility.getHeader = uipanel(hParent,'Title','Get qsm_hub header',...
    ...
    h.Utility.getHeader.text.dicomInput = uicontrol(h.StepsPanel.Utility.getHeader,...
        ...
        'backgroundcolor',get(hFig,'color'),...
        'tooltip',...
        strcat('Input directory contains DICOM (both magnitude and phase files under the same directory) files. ',...
         'No user input will be saved if your input is a DICOM directory.'));
    ...
    h.Utility.getHeader.text.user = uicontrol(h.StepsPanel.Utility.getHeader,...
        ...
        'backgroundcolor',get(hFig,'color'),...
        'tooltip',...
        'User input will replace the header information extracted from the input NIfTI header.');
    % B0 strength
