...
%
% Description: constructs a 'text|edit' pair on the GUIs
%
...
%
%
function [h_text,h_edit] = sepia_construct_text_edit(parent,fieldString,defaultValue,pos,wratio,isbracket)
