...
%
% Description: read edit string from config file to GUI
%
...
%
%
function val = sepia_read_edit_string(config_txt, str_pattern, action_handle)

% get value between = and ;, should be either 1 or 0
val = get_num_as_string(config_txt, str_pattern, '=', ';');

% set the value on the GUI
set_non_nan_value(action_handle, 'String', val);
