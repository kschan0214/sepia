...
%
%
function h = sepia_handle_panel_R2s_GeometricSum(hParent,h,position)
...
h.r2s.panel.gs = uipanel(hParent,...
    'Title','Geometric sum',...
    'position',position,...
...
%% Children of CFS panel
    ...
    [h.r2s.gs.text.s0,h.r2s.gs.popup.s0] = sepia_construct_text_popup(...
