...
%
%
function h = sepia_handle_panel_R2s_LinearRegression(hParent,h,position)
...
h.r2s.panel.lr = uipanel(hParent,...
...
% %     [h.r2s.lr.text.s0,h.r2s.lr.popup.s0] = sepia_construct_text_popup(...
% %         panelParent,'S0 extrapolation:', menuS0, [left(1) bottom(4) width height], wratio);
