...
%
%
function h = sepia_handle_panel_R2s_ARLO(hParent,h,position)
...
h.r2s.panel.arlo = uipanel(hParent,...
    'Title','ARLO',...
    'position',position,...
...
%% Children of CFS panel
    ...
    [h.r2s.arlo.text.s0,h.r2s.arlo.popup.s0] = sepia_construct_text_popup(...
