...
%
%
function h = sepia_handle_panel_R2s_Trapezoidal(hParent,h,position)
...
h.r2s.panel.trapezoidal = uipanel(hParent,...
    'Title','Trapezoidal',...
    'position',position,...
...
%% Children of CFS panel
    ...
    panelParent = h.r2s.panel.trapezoidal;
    ...
    [h.r2s.trapezoidal.text.s0,h.r2s.trapezoidal.popup.s0] = sepia_construct_text_popup(...
