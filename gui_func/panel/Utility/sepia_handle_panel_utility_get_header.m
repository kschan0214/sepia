...
h.Utility.panel.getHeader = uipanel(hParent,'Title','Get SEPIA header',...
    ...
    h.Utility.getHeader.edit.dicomInput = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','edit',...
        'units','normalized','position',[0.21 button(10) 0.75 height],...
        'HorizontalAlignment','left',...
    ...
    h.Utility.getHeader.button.dicomInput = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','pushbutton',...
        'units','normalized','position',[0.96 button(10) 0.03 height],...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color(),...
        'CData',open_icon);
    ...
    h.Utility.getHeader.edit.niftiDirInput = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','edit',...
        'units','normalized','position',[0.21 button(9) 0.75 height],...
        'HorizontalAlignment','left',...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color());
    h.Utility.getHeader.button.niftiDirInput = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','pushbutton',...
        'units','normalized','position',[0.96 button(9) 0.03 height],...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color(),...
        'CData',open_icon);
    ...
    h.Utility.getHeader.edit.niftiInput = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','edit',...
        'units','normalized','position',[0.21 button(8) 0.25 height],...
        'HorizontalAlignment','left',...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color());
    h.Utility.getHeader.button.niftiInput = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','pushbutton',...
        'units','normalized','position',[0.46 button(8) 0.03 height],...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color(),...
        'CData',open_icon);
    % TE file
    ...
    h.Utility.getHeader.edit.teFile = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','edit',...
        'units','normalized','position',[0.71 button(8) 0.25 height],...
        'HorizontalAlignment','left',...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color());
    h.Utility.getHeader.button.teFile = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','pushbutton',...
        'units','normalized','position',[0.96 button(8) 0.03 height],...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color(),...
        'CData',open_icon);
    ...
    h.Utility.getHeader.edit.outputDir = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','edit',...
        'units','normalized','position',[0.21 button(7) 0.75 height],...
        'HorizontalAlignment','left',...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color());
    h.Utility.getHeader.button.outputDir = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','pushbutton',...
        'units','normalized','position',[0.96 button(7) 0.03 height],...
        'backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color(),...
        'CData',open_icon);
    ...
    h.Utility.getHeader.text.userTE = uicontrol('Parent',h.Utility.panel.getHeader,...
        'Style','text','String','or user input TEs (second)',...
        'units','normalized','Position',[0.01 button(2) 0.2 height],...
        'HorizontalAlignment','left',...
        'backgroundcolor',get(h.fig,'color'),...
        'tooltip','Specify the echo times (TE, in second) of all echo');
...
switch field
    ...
    case 'nitfi'
        % read NIfTI file 
        [nitfiName,pathDir] = uigetfile({'*.nii;*.nii.gz','NIfTI file (*.nii,*.nii.gz)'; '*.nii','NIfTI file (*.nii)'; '*.nii.gz','Gzipped NIfTI file (*.nii.gz)'},'Select mask file');
