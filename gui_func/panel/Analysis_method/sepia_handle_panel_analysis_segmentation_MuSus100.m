...
h.Analysis.panel.Segmentation_MuSus100 = uipanel(hParent,'Title','Segmentation - MuSus-100 atlas',...
    'Position',position,...
    'backgroundcolor',get(h.fig,'color'),'Visible','off');
    
    panelParent = h.Analysis.panel.Segmentation_MuSus100;
    ...
    [h.Analysis.segmentation.MuSus100.text.greMaskInput,...
     h.Analysis.segmentation.MuSus100.edit.greMaskInput,...
     h.Analysis.segmentation.MuSus100.button.greMaskInput] = sepia_construct_text_edit_button(panelParent,...
        'Select a GRE mask NIfTI file:',[],open_icon,pos,wratio);
    
    pos = [left(1) bottom(4) width height];
    [h.Analysis.segmentation.MuSus100.text.t1wInput,...
     h.Analysis.segmentation.MuSus100.edit.t1wInput,...
     h.Analysis.segmentation.MuSus100.button.t1wInput] = sepia_construct_text_edit_button(panelParent,...
        'Select a T1w NIfTI file:',[],open_icon,pos,wratio);
    
    pos = [left(1) bottom(5) width height];
    [h.Analysis.segmentation.MuSus100.text.t1wMaskInput,...
     h.Analysis.segmentation.MuSus100.edit.t1wMaskInput,...
     h.Analysis.segmentation.MuSus100.button.t1wMaskInput] = sepia_construct_text_edit_button(panelParent,...
        'Select a T1w mask NIfTI file:',[],open_icon,pos,wratio);
    
    pos = [left(1) bottom(6) width height];
    [h.Analysis.segmentation.MuSus100.text.chiInput,...
     h.Analysis.segmentation.MuSus100.edit.chiInput,...
     h.Analysis.segmentation.MuSus100.button.chiInput] = sepia_construct_text_edit_button(panelParent,...
    ...
    [h.Analysis.segmentation.MuSus100.text.gre2T1wMat,...
     ...
     h.Analysis.segmentation.MuSus100.button.gre2T1wMat] = sepia_construct_text_edit_button(panelParent,...
        'Select a GRE-to-T1w rigid-body transformation:',[],open_icon,pos,wratio);
    pos = [left(1) bottom(10) width height];
    [h.Analysis.segmentation.MuSus100.text.t1w2TemplateMat,...
     h.Analysis.segmentation.MuSus100.edit.t1w2TemplateMat,...
     h.Analysis.segmentation.MuSus100.button.t1w2TemplateMat] = sepia_construct_text_edit_button(panelParent,...
        'Select a T1w-to-Atlas affine transformation:',[],open_icon,pos,wratio);
    pos = [left(1) bottom(11) width height];
    [h.Analysis.segmentation.MuSus100.text.t1w2TemplateNii,...
     h.Analysis.segmentation.MuSus100.edit.t1w2TemplateNii,...
     h.Analysis.segmentation.MuSus100.button.t1w2TemplateNii] = sepia_construct_text_edit_button(panelParent,...
...
set(h.Analysis.segmentation.MuSus100.button.greInput,           'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.MuSus100.edit.greInput,[1 2]});
set(h.Analysis.segmentation.MuSus100.button.greMaskInput,       'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.MuSus100.edit.greMaskInput,[1 2]});
set(h.Analysis.segmentation.MuSus100.button.t1wInput,           'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.MuSus100.edit.t1wInput,[1 2]});
set(h.Analysis.segmentation.MuSus100.button.t1wMaskInput,       'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.MuSus100.edit.t1wMaskInput,[1 2]});
set(h.Analysis.segmentation.MuSus100.button.chiInput,           'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.MuSus100.edit.chiInput,[1 2]});

set(h.Analysis.segmentation.MuSus100.button.greInput2,        	'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.MuSus100.edit.greInput2,[1 1]});
set(h.Analysis.segmentation.MuSus100.button.gre2T1wMat,         'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'mat',h.Analysis.segmentation.MuSus100.edit.gre2T1wMat,[1 1]});
set(h.Analysis.segmentation.MuSus100.button.t1w2TemplateMat,	'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'mat',h.Analysis.segmentation.MuSus100.edit.t1w2TemplateMat,[1 1]});
set(h.Analysis.segmentation.MuSus100.button.t1w2TemplateNii,	'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.MuSus100.edit.t1w2TemplateNii,[1 1]});
set(h.Analysis.segmentation.MuSus100.button.outputDir,          'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'dir',h.Analysis.segmentation.MuSus100.edit.outputDir,[0]});

set(h.Analysis.segmentation.MuSus100.button.start,             'Callback', {@PushbuttonStart_Analysis_segmentation_Callback,h});
end
...
switch field
    case 'nitfi'
        ...
        [niftiFileName,pathDir] = uigetfile({'*.nii;*.nii.gz','NIfTI file (*.nii,*.nii.gz)'; '*.nii','NIfTI file (*.nii)'; '*.nii.gz','Gzipped NIfTI file (*.nii.gz)'},'Select a NIFTI file');
...
if clearField(1)
    switch clearField(2)
        case 1
            set(h.Analysis.segmentation.MuSus100.edit.greInput,'String','');
            set(h.Analysis.segmentation.MuSus100.edit.greMaskInput,'String','');
            set(h.Analysis.segmentation.MuSus100.edit.t1wInput,'String','');
            set(h.Analysis.segmentation.MuSus100.edit.t1wMaskInput,'String','');
            set(h.Analysis.segmentation.MuSus100.edit.chiInput,'String','');
            
        case 2
            set(h.Analysis.segmentation.MuSus100.edit.greInput2,'String','');
            set(h.Analysis.segmentation.MuSus100.edit.gre2T1wMat,'String','');
            set(h.Analysis.segmentation.MuSus100.edit.t1w2TemplateMat,'String','');
            set(h.Analysis.segmentation.MuSus100.edit.t1w2TemplateNii,'String','');
    end
end
...
% get input from GUI
% option 1
input.gre       = get(h.Analysis.segmentation.MuSus100.edit.greInput,       'String');
input.greMask 	= get(h.Analysis.segmentation.MuSus100.edit.greMaskInput, 	'String');
input.t1w       = get(h.Analysis.segmentation.MuSus100.edit.t1wInput,       'String');
input.t1wMask  	= get(h.Analysis.segmentation.MuSus100.edit.t1wMaskInput, 	'String');
input.chi       = get(h.Analysis.segmentation.MuSus100.edit.chiInput,       'String');
if ~isempty(input.greMask)
    isPathway1 = true;
else
    % option 2  
    input.gre               = get(h.Analysis.segmentation.MuSus100.edit.greInput2,      'String');
    input.gre2T1wMat        = get(h.Analysis.segmentation.MuSus100.edit.gre2T1wMat, 	'String');
    input.t1w2TemplateMat 	= get(h.Analysis.segmentation.MuSus100.edit.t1w2TemplateMat,'String');
    input.t1w2TemplateiWrap	= get(h.Analysis.segmentation.MuSus100.edit.t1w2TemplateNii,'String');
    isPathway1 = false;
end
% output
