...
%
%
function h = sepia_handle_panel_analysis_segmentation_CIT168RL(hParent,h,position)
...
h.Analysis.panel.Segmentation_CIT168RL = uipanel(hParent,'Title','Segmentation - CIT168 Reinforcement learning atlas',...
    'Position',position,...
    'backgroundcolor',get(h.fig,'color'),'Visible','on');
    
    panelParent = h.Analysis.panel.Segmentation_CIT168RL;
    ...
    [h.Analysis.segmentation.CIT168RL.text.greMaskInput,...
     h.Analysis.segmentation.CIT168RL.edit.greMaskInput,...
     h.Analysis.segmentation.CIT168RL.button.greMaskInput] = sepia_construct_text_edit_button(panelParent,...
        'Select a GRE mask NIfTI file:',[],open_icon,pos,wratio);
    
    pos = [left(1) bottom(4) width height];
    [h.Analysis.segmentation.CIT168RL.text.t1wInput,...
     h.Analysis.segmentation.CIT168RL.edit.t1wInput,...
     h.Analysis.segmentation.CIT168RL.button.t1wInput] = sepia_construct_text_edit_button(panelParent,...
        'Select a T1w NIfTI file:',[],open_icon,pos,wratio);
    
    pos = [left(1) bottom(5) width height];
    [h.Analysis.segmentation.CIT168RL.text.t1wMaskInput,...
...
set(h.Analysis.segmentation.CIT168RL.button.greInput,           'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.CIT168RL.edit.greInput,[1 2]});
...
set(h.Analysis.segmentation.CIT168RL.button.t1w2TemplateMat,	'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'mat',h.Analysis.segmentation.CIT168RL.edit.t1w2TemplateMat,[1 1]});
set(h.Analysis.segmentation.CIT168RL.button.t1w2TemplateNii,	'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'nitfi',h.Analysis.segmentation.CIT168RL.edit.t1w2TemplateNii,[1 1]});
set(h.Analysis.segmentation.CIT168RL.button.outputDir,          'Callback', {@ButtonOpen_Analysis_segmentation_Callback,h,'dir',h.Analysis.segmentation.CIT168RL.edit.outputDir,[0]});

set(h.Analysis.segmentation.CIT168RL.button.start,             'Callback', {@PushbuttonStart_Analysis_segmentation_Callback,h});
end
...
if clearField(1)
    switch clearField(2)
        case 1
            set(h.Analysis.segmentation.CIT168RL.edit.greInput,'String','');
            set(h.Analysis.segmentation.CIT168RL.edit.greMaskInput,'String','');
            set(h.Analysis.segmentation.CIT168RL.edit.t1wInput,'String','');
            set(h.Analysis.segmentation.CIT168RL.edit.t1wMaskInput,'String','');
            
        case 2
            set(h.Analysis.segmentation.CIT168RL.edit.greInput2,'String','');
            set(h.Analysis.segmentation.CIT168RL.edit.gre2T1wMat,'String','');
            set(h.Analysis.segmentation.CIT168RL.edit.t1w2TemplateMat,'String','');
            set(h.Analysis.segmentation.CIT168RL.edit.t1w2TemplateNii,'String','');
    end
end
...
% get input from GUI
% option 1
input.gre       = get(h.Analysis.segmentation.CIT168RL.edit.greInput,       'String');
...
if ~isempty(input.greMask)
    ...
    % option 2  
    input.gre               = get(h.Analysis.segmentation.CIT168RL.edit.greInput2,      'String');
    input.gre2T1wMat        = get(h.Analysis.segmentation.CIT168RL.edit.gre2T1wMat, 	'String');
    input.t1w2TemplateMat 	= get(h.Analysis.segmentation.CIT168RL.edit.t1w2TemplateMat,'String');
    input.t1w2TemplateiWrap	= get(h.Analysis.segmentation.CIT168RL.edit.t1w2TemplateNii,'String');
    isPathway1 = false;
end
% output
