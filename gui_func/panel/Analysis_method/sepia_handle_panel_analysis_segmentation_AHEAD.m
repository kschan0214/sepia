...
h.Analysis.panel.Segmentation_AHEAD = uipanel(hParent,'Title','Segmentation - AHEAD atlas',...
    ...
    h.Analysis.segmentation.AHEAD.button.start = uicontrol('Parent',panelParent,'Style','pushbutton','backgroundcolor',sepia_theme_bg_color(),'foregroundcolor',sepia_theme_fg_color(),'units','normalized',...
