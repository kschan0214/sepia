...
% input(1).name = '/project/3015069.01/pilot/qsmhubTestdata/SEPIA_QA/derivatives/SEPIA/segmentation_up/CIT168_reinf_learn_intermediate_files/GRE_2_T1w_0GenericAffine.mat';
% % T1w to MNI 2009c, Affine
% input(2).name = '/project/3015069.01/pilot/qsmhubTestdata/SEPIA_QA/derivatives/SEPIA/segmentation_up/CIT168_reinf_learn_intermediate_files/T1w_2_CIT168toMNI152-2009c_T1w_brain_0GenericAffine.mat';
% % T1w to MNI 2009c, Warp
% input(3).name = '/project/3015069.01/pilot/qsmhubTestdata/SEPIA_QA/derivatives/SEPIA/segmentation_up/CIT168_reinf_learn_intermediate_files/T1w_2_CIT168toMNI152-2009c_T1w_brain_1InverseWarp.nii.gz';
% input(4).name = '/project/3015069.01/pilot/qsmhubTestdata/SEPIA_QA/MGRE_original/sub-001_echo-1_part-mag_MEGRE.nii.gz';
% end
% output_dir      = '/project/3015069.01/pilot/qsmhubTestdata/SEPIA_QA/derivatives/SEPIA/segmentation_up/mat/';
...
output_dir      = '/project/3015069.01/pilot/qsmhubTestdata/SEPIA_QA/derivatives/SEPIA/segmentation_MuSus100/';
algorParam.isBiasFieldCorr	= 1;
algorParam.mode             = mode;
...
output_dir      = '/project/3015069.01/pilot/qsmhubTestdata/SEPIA_QA/derivatives/SEPIA/segmentation_AHEAD/';
algorParam.isBiasFieldCorr	= 1;
algorParam.mode             = mode;
