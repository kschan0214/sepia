...
%
%
function [r2s,t2s,m0] = Wrapper_R2s_SequenceOfProduct(magn,te,mask,algorParam,headerAndExtraData)
sepia_universal_variables;

% get algorithm parameters
algorParam  = check_and_set_algorithm_default(algorParam);
method      = algorParam.r2s.method;
s0mode     	= algorParam.r2s.s0mode;
...
%% main
[r2s,t2s,m0] = R2star_pi(magn,te,s0mode,piMethod);
...
try algorParam2.r2s.s0mode      = algorParam.r2s.s0mode;    catch; algorParam2.r2s.s0mode   = '1stecho'; end
