...
%
%
function [RDF] = Wrapper_BFR_VSHARPSTI2D(totalField,mask,matrixSize,voxelSize,algorParam, headerAndExtraData)
...
%% main
RDF = V_SHARP_2d(totalField, mask,'voxelsize',voxelSize(:)','smvsize',radius);
