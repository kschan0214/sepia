...
%     % polyfit
%     fprintf(fid,'algorParam.bfr.refine = %i ;\n'        ,get(h.bkgRemoval.checkbox.refine,'Value'));
    % polyfit method
    fprintf(fid,'algorParam.bfr.refine_method = ''%s'' ;\n' 	,h.bkgRemoval.popup.refine.String{h.bkgRemoval.popup.refine.Value,1});
    % polyfit order
    fprintf(fid,'algorParam.bfr.refine_order = %s ;\n' 	,get(h.bkgRemoval.edit.order,'String'));
    % Erode local field
