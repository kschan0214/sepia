...
{
  if (filetype==FSL_TYPE_ANALYZE)          return (char*)"ANALYZE-7.5";
  if (filetype==FSL_TYPE_NIFTI)            return (char*)"NIFTI-1+";
  if (filetype==FSL_TYPE_NIFTI_PAIR)       return (char*)"NIFTI-1";
  if (filetype==FSL_TYPE_ANALYZE_GZ)       return (char*)"ANALYZE-7.5";
  if (filetype==FSL_TYPE_NIFTI_GZ)         return (char*)"NIFTI-1+";
  if (filetype==FSL_TYPE_NIFTI_PAIR_GZ)    return (char*)"NIFTI-1";
  return (char*)"UNKNOWN";
}
