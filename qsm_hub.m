...
tabGroup = uitabgroup(fig,'position',[.01 .01 1 1]);
tabQSMWhole = uitab(tabGroup,'Title','One-stop QSM processing');
tabPhaseUnwrap = uitab(tabGroup,'Title','Phase unwrapping');
tabBKGRemoval = uitab(tabGroup,'Title','Background field removal');
tabQSM = uitab(tabGroup,'Title','QSM');

%% I/O
h.panel_dataIO = uipanel(tabQSMWhole,'Title','I/O',...
...
%% phase unwrap
h.panel_phaseUnwrap = uipanel(tabQSMWhole,'Title','Total field recovery and phase unwrapping',...
...
%% background field
h.panel_bkgRemoval = uipanel(tabQSMWhole,'Title','Background field removal',...
...
%% QSM
h.panel_qsm = uipanel(tabQSMWhole,'Title','QSM','backgroundcolor',get(fig,'color'),...
...
h.pushbutton_start = uicontrol('Parent',tabQSMWhole,'Style','pushbutton',...
    'String','Start',...
