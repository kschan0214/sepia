...
addons.method = 'SWI (2D Hanning)';

% Specify the filename of the wrapper function (without extension)
addons.wrapper_function	= 'Wrapper_SWISMWI_SWI_2DHanning';
...
addons.gui_method_panel	= 'sepia_handle_panel_swismwi_SWI_2DHanning';
...
addons.config_function	= 'get_set_swismwi_swi_2dhanning';