...
if ~isempty(varargin)
    for kvar=1:length(varargin)
        if strcmpi(varargin{kvar},'tol')
            tol = varargin{kvar+1};
            continue
        end
        if strcmpi(varargin{kvar},'iteration')
            itermax = varargin{kvar+1};
            continue
        end
        if strcmpi(varargin{kvar},'CGsolver')
            isMEDICG = varargin{kvar+1};
            continue
        end
    end
end
