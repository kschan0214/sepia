function varargout = Gray_GUI(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Gray_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @Gray_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Gray_GUI is made visible.
function Gray_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Gray_GUI (see VARARGIN)

% Choose default command line output for Gray_GUI
...
% UIWAIT makes Gray_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);
guidata(hObject, handles);

% --- Outputs from this function are returned to the command line.
function varargout = Gray_GUI_OutputFcn(hObject, eventdata, handles) 
