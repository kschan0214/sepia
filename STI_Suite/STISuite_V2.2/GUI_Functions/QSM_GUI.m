function varargout = QSM_GUI(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @QSM_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @QSM_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before QSM_GUI is made visible.
function QSM_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to QSM_GUI (see VARARGIN)

% Choose default command line output for QSM_GUI
...
% UIWAIT makes QSM_GUI wait for user response (see UIRESUME)
...
function varargout = QSM_GUI_OutputFcn(hObject, eventdata, handles) 
...
LoadImagesEssential(hObject,handles,1);
...
LoadBinFileEssential(hObject,handles,22);
...
LoadImagesEssential(hObject,handles,2);
...
LoadBinFileEssential(hObject,handles,44);
...
LoadImagesEssential(hObject,handles,3);
...
LoadBinFileEssential(hObject,handles,45);
...
% --- Executes on button press in QSM.
function QSM_Callback(hObject, eventdata, handles)
QSMEssential(hObject,handles)
...
LoadImagesEssential(hObject,handles,8);
...
% --- Executes on button press in flipLRdirection.
function flipLRdirection_Callback(hObject, eventdata, handles)
PermuteImages(hObject,handles,4)



% --- Executes during object creation, after setting all properties.
function PanalSelection_CreateFcn(hObject, eventdata, handles)
% hObject    handle to PanalSelection (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
