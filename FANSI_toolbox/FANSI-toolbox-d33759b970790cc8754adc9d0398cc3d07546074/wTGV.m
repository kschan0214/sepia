% QSM with a Total Generalized Variation regularization with spatially variable fidelity and regularization weights.
...
% out.v - auxiliary variable in the TGV regularization
%
       tic
    ...
    for outer = 1:maxOuterIter
        ...
        rhs1    =  mu2*Kt.*(z2-s2)     + mu1*(Et1.*F_z1_minus_s1_1 + Et2.*F_z1_minus_s1_2 + Et3.*F_z1_minus_s1_3);
        ...
        z2 = FWy + mu2*fftn( real(ifftn(K.*Fx+s2))./(weight + mu2) );
